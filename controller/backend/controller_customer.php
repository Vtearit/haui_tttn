<?php 
	class controller_customer{
		...
		public function __construct(){
			...
			$total = $this->model->count("select * from tbl_customer");
			...
			$arr = $this->model->fetch("select * from tbl_customer order by customer_id desc limit $from,$record_per_page");
			//--------
			//load view
			include "view/backend/view_customer.php";
		}
	}
