...
<div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
    <div class="onlyforchrome" style="font-size: 30px;text-align: center;font-family: Helvetica;">Hùng Phát Computer</div><br>
    <div class="onlyforchrome" style="margin-top:5px;text-align:center;color:#8a8a8a;margin-bottom:80px; font-size:.8em;line-height:1.2em;font-family: Georgia;"><a href="#"><strong>T-Rex Dino game,</strong></a> mời bạn chơi tạm cho đỡ buồn vì chưa nghĩ ra <a href="#"><strong>thông tin liên hệ</strong></a>.<br/> Press "Up" to jump your Dino and start the game.</div>
