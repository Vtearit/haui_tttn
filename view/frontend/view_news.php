<h1>Tin tức</h1>
        <div class="wrapper-blog"> 
          ...
          <?php 
            ...
            {
           ?>
            <div class="col-md-6 article"> <a href="index.php?controller=news_detail&id=<?php echo $rows->pk_news_id; ?>" class="image"> <img src="public/upload/news/<?php echo $rows->c_img; ?>" alt="<?php echo $rows->c_name; ?>" title="<?php echo $rows->c_name; ?>" class="img-responsive" style="height: 230px; width: 100%;"> </a>
